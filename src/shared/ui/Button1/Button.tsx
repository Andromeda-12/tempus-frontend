    ...
    return (
      <button
        ...
        className={clsx(
          ...
          dense && 'py-1',
          variant === 'contained' &&
            'bg-accent text-white dark:text-white hover:bg-accent-hover active:bg-accent-hover/70 active:scale-95 focus-visible:bg-accent-hover',
          variant === 'outline' &&
      ...
      >
        ...
        {startIcon && <Icon className='mr-2 !w-4 !h-4' >{startIcon}</Icon>}
