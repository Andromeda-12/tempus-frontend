...
interface PaginationBoxViewProps {
  ...
  pageLabelBuilder: (page: number) => number
  ...
  ariaLabelBuilder: () => void
  eventListener: string
  renderOnZeroPageCount: () => void | undefined
...
// export const PaginationBoxVieww = ({
//   initialPage,
//   forcePage,
...
function classNameIfDefined(className: string, orClassName = '') {
  return className !== undefined && className !== null ? className : orClassName
}
...
export default class PaginationBoxView extends Component {
  ...
  constructor(props: PaginationBoxViewProps) {
    super(props)
  ...
  componentDidMount() {
    const {
      ...
      pageCount,
      forcePage
    } = this.props as PaginationBoxViewProps
